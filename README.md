...
Central index for this repository. Use this file to quickly find the most important notes and practice projects.

## Repository map
- `deeplearning.ai/ai-for-everyone/`
  Main theory notes from the course, including AI foundations, ML workflows, and project decisions.
...
- `### How it works` for the `A -> B` ML concept
- `### What machine learning can and cannot do` for practical limits
- `### An explanation of deep learning` for layer-by-layer intuition
...
Key sections:
- `### How Generative AI works` for the core mental model
- `### Web-based vs. software application use of LLMs` for product usage patterns
- `### Common use cases of Generative AI` for practical application ideas
- `### Limitations and risks` for hallucinations, bias, and privacy concerns
- `### Image generation (diffusion model)` for a simple image-model explanation
- `## Generative AI Projects` for lifecycle, `RAG`, and `RLHF`
- `## Generative AI in Business and Society` for augmentation vs. automation and responsible AI
